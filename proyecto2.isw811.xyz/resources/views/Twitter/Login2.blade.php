	...
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form method="POST" action="{{ route('login') }}">
					<h3 class="register-heading">you need to login to connect to your <strong> twitter  account</strong></h3>
					</form>
				</div>
				@endauth
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="{{ route('home') }}" class="ml-2 link">Sign Up</a>
					</div>
				</div>
			</div>
		</div>
